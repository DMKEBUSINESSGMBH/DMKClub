...
use DMKClub\Bundle\MemberBundle\Model\ExtendFeeCategory;
 ...
 * @ORM\Entity(repositoryClass="DMKClub\Bundle\MemberBundle\Entity\Repository\FeeCategoryRepository")
 * @ORM\Table(name="dmkclub_feecategory")
 * @ORM\HasLifecycleCallbacks()
 * @Config(
 *      routeName="dmkclub_feecategory_index",
 *      routeView="dmkclub_feecategory_view",
 *      defaultValues={
 *          "entity"={
 *              "icon"="icon-star"
 *          },
 ...
 */
class FeeCategory extends ExtendFeeCategory  {
