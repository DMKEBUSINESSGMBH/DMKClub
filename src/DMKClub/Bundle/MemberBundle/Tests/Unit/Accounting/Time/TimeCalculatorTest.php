...
class TimeSpanCalculatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function lastDayProvider() {
		return [
				[new \DateTime('2016-07-01'), new \DateTime('2016-07-31')],
				[new \DateTime('2016-07-05'), new \DateTime('2016-07-31')],
				[new \DateTime('2016-07-31'), new \DateTime('2016-07-31')],
				[new \DateTime('2016-02-10'), new \DateTime('2016-02-29')],
				[new \DateTime('2016-12-01'), new \DateTime('2016-12-31')],
		];
	}
}
