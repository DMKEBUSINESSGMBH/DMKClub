	...
	public function dataProvider() {
		...
		return [
				...
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2010-02-01', NULL, '1970-05-13'), 12000, 12000, 1, 'simplefull'],
				// Vollzahler mit Eintritt
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2016-08-01', NULL, '1970-05-13'), 11000, 11350, 2, 'newfull2'],
				// Vollzahler mit Austritt
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2015-08-01', '2016-08-01', '1970-05-13'), 2000, 2000, 1, 'retiredfull'],
				// Kinderbeitrag über gesamte Laufzeit
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2010-02-01', NULL, ($year - 10).'-05-13'), 2400, 2400, 1, 'simplechild'],
				// Kinderbeitrag die ersten 11 Monate. Ab 18 voller Preis (Geburtstag im Mai, voller Beitrag ab Juni)
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2010-02-01', NULL, ($year - 17).'-05-13'), 3200, 3200, 1, 'child2full'],
				// Kinderbeitrag die ersten 11 Monate. Austritt mit Volljährigkeit am 1.5. (Geburtstag im Mai)
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2010-02-01', '2017-05-01', ($year - 17).'-05-13'), 2200, 2200, 1, 'child2fullretired'],
				// Kinderbeitrag nach Neueintritt die ersten 10 Monate. Letzter Monat Vollzahler
				[new \DateTime('2016-07-01'), new \DateTime('2017-06-30'), $feeOptions,
						$this->buildMember('2016-08-01', NULL, ($year - 17).'-05-13'), 3000, 3350, 2, 'child2fullnew'],
